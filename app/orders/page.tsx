      ...
      >
        <div className="max-w-7xl mx-auto z-10 relative">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 mb-4 border border-slate-200 shadow-sm flex justify-between items-center">
            ...
            <Link 
              href="/orders/new" 
              className="bg-brand-blue hover:opacity-90 text-white px-4 py-2 rounded-lg text-xs font-bold shadow-sm transition-all flex items-center space-x-1"
            >
              <span>＋</span>
              <span>新規登録</span>
            </Link>
                      ...
                      <td className="py-3.5 px-4 text-center">
                        <div className="flex justify-center space-x-1.5">
                          <Link 
                            ...
                            className="bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300 px-2.5 py-1 rounded text-[11px] font-medium transition-colors"
                          >
                            詳細
                          </Link>
                          <Link 
                            href={`/orders/${order.id}/edit`}
                            className="bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 px-2.5 py-1 rounded text-[11px] font-medium transition-colors"
                          >
                            編集
                          </Link>
                        </div>
