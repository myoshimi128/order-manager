...
一般事務職として現場の業務課題を把握したうえで、現役エンジニアから開発の進め方を教わりながら習得した TypeScript / Next.js / Supabase を用いて、要件定義から実装までを担当しました。

※ 社内提案用に開発したプロトタイプです。既存システムの構成上、実運用の導入には至っていません。
...
個人開発（現役エンジニアから開発プロセスの指導を受けつつ、要件定義・DB設計・実装・社内提案資料の作成を担当）
